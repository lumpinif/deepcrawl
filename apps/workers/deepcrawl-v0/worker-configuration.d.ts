/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: b32a78b0ef9e5b4b821cb2dbad4ca099)
...
declare namespace Cloudflare {
	interface Env {
		...
		DEEPCRAWL_AUTH_WORKER: Fetcher /* deepcrawl_auth */;
		AI: Ai;
	}
}
