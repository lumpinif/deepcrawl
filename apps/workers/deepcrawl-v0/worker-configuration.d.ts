/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 98315fa12e42711ab4d97d9b0b6229b9)
...
declare namespace Cloudflare {
	interface Env {
		...
		WORKER_NODE_ENV: "development" | "staging" | "production";
		SUPABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKER_NODE_ENV" | "SUPABASE_URL" | "SUPABASE_ANON_KEY">> {}
}
