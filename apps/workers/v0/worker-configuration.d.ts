/* eslint-disable */
// Generated by Wrangler by running `wrangler types --c wrangler.jsonc --c ../auth/wrangler.jsonc --env-interface=CloudflareBindings` (hash: 9ae2b341e58511117d03798705743608)
// Runtime types generated with workerd@1.20251001.0 2025-05-22 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		API_URL: "http://localhost:8080" | "https://api.deepcrawl.dev";
		WORKER_NODE_ENV: "development" | "production";
		...
		DB_V0: D1Database;
		/* NOTE: CRITICAL WORKAROUND: MANUALLY OVERRIDE THIS TO THE WORKSPACE PATH INSTEAD OF RELATIVE PATH AFTER GENERATING THE TYPES EVERYTIME. OR USE PNPM RUN CF-TYPEGEN WORKFLOW TO AUTOMATE THIS */
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_URL" | "WORKER_NODE_ENV" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "DATABASE_URL" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "NEXT_PUBLIC_GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "RESEND_API_KEY" | "UPSTASH_REDIS_REST_URL" | "UPSTASH_REDIS_REST_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN" | "DEEPCRAWL_API_KEY">> {}
}
