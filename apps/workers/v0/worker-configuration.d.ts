/* eslint-disable */
// Generated by Wrangler by running `wrangler types --c wrangler.jsonc --c ../auth/wrangler.jsonc --env-interface=CloudflareBindings` (hash: bdaef4121ef8f1905857433fb54b299e)
...
declare namespace Cloudflare {
	interface Env {
		...
		DATABASE_URL: string;
		AUTH_WORKER: Service /* entrypoint AuthWorker from deepcrawl-worker-auth */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_URL" | "WORKER_NODE_ENV" | "BETTER_AUTH_URL" | "DATABASE_URL">> {}
}
