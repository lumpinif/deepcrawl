/* eslint-disable */
// Generated by Wrangler by running `wrangler types --c wrangler.jsonc --c ../auth/wrangler.jsonc --env-interface=CloudflareBindings` (hash: 78a3b4df9b1b4a69a58386e632863379)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKER_NODE_ENV" | "API_URL" | "ENABLE_ACTIVITY_LOGS" | "NEXT_PUBLIC_APP_URL" | "BETTER_AUTH_URL" | "BETTER_AUTH_SECRET" | "DATABASE_URL" | "AUTH_MODE" | "JWT_SECRET" | "JWT_ISSUER" | "JWT_AUDIENCE" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "NEXT_PUBLIC_GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "RESEND_API_KEY" | "UPSTASH_REDIS_REST_URL" | "UPSTASH_REDIS_REST_TOKEN" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_DATABASE_ID" | "CLOUDFLARE_D1_TOKEN">> {}
}
