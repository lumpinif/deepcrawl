/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: fb8186fabea062064974df7b9e54e345)
...
declare namespace Cloudflare {
	interface Env {
		...
		DATABASE_URL: string;
		DEEPCRAWL_AUTH_WORKER: Service /* entrypoint AuthWorker from deepcrawl-worker-auth-production */;
		AI: Ai;
	}
}
