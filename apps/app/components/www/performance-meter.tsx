...
export const PerformanceMeter = () => {
  ...
  useEffect(() => {
    ...
    const runAnimation = async () => {
      ...
      const oscillate = async (): Promise<void> => {
        ...
        const randomTarget = 85 + Math.random() * 10;
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute right-0 bottom-0 left-0 h-5 bg-gradient-to-t from-background-subtle to-transparent" />
    </div>
  );
};
