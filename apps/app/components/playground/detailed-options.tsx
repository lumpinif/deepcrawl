...
// import type {
//   DeepcrawlOperations,
//   ExtractLinksOptionsForHook,
//   GetMarkdownOptionsForHook,
//   ReadUrlOptionsForHook,
...
//         getValue: (options) => options.markdown,
...
//           const markdownOptions = options.markdownConverterOptions;
...
//         getValue: (getOptionValue) => getOptionValue('metadata'),
//         getDisplayValue: (value, getOptionValue) => {
//           if (!value) {
//             return (
//               <Badge className="text-muted-foreground" variant="outline">
//                 <X className="mr-1 size-3" />
...
//           const metadataOptions = getOptionValue('metadataOptions');
...
//         operations: ['readUrl', 'extractLinks'],
//         getValue: (getOptionValue) => getOptionValue('cleanedHtml'),
...
//         operations: ['readUrl'],
//         getValue: (getOptionValue) => getOptionValue('rawHtml'),
//         getDisplayValue: (value) =>
//           value ? (
//             <Badge className="" variant="secondary">
//               <Check className="mr-1 size-3" />
...
//         operations: ['readUrl', 'extractLinks'],
//         getValue: (getOptionValue) => getOptionValue('robots'),
//         getDisplayValue: (value) =>
//           value ? (
//             <Badge className="" variant="secondary">
//               <Check className="mr-1 size-3" />
...
//         getValue: (getOptionValue) => getOptionValue('tree'),
//         getDisplayValue: (value, getOptionValue) => {
//           if (!value) {
//             return (
//               <Badge className="text-muted-foreground" variant="outline">
...
//           const treeOptions = getOptionValue('treeOptions');
...
//         operations: ['extractLinks'],
//         getValue: (getOptionValue) => getOptionValue('sitemapXML'),
//         getDisplayValue: (value) =>
//           value ? (
//             <Badge className="" variant="secondary">
//               <Check className="mr-1 size-3" />
...
//           const options = getOptionValue('linkExtractionOptions') as
...
//         operations: 'all',
//         getValue: (getOptionValue) => getOptionValue('cleaningProcessor'),
//         getDisplayValue: (value) => {
...
//         operations: 'all',
//         getValue: (getOptionValue) => {
//           const options = getOptionValue('cacheOptions') as
//             | Record<string, unknown>
//             | undefined;
//           return options?.enabled;
//         },
//         getDisplayValue: (value, getOptionValue) => {
//           const cacheOptions = getOptionValue('cacheOptions') as
//             | Record<string, unknown>
//             | undefined;
...
//         operations: ['readUrl', 'extractLinks'],
//         getValue: (getOptionValue) => {
//           const options = getOptionValue('metricsOptions') as
//             | Record<string, unknown>
//             | undefined;
...
// // Discriminated union props for type safety
// type DetailedOptionsProps =
//   | {
//       operation: 'readUrl';
//       options: ReadUrlOptionsForHook;
//       requestUrl: string;
//       className?: string;
...
//       options: ExtractLinksOptionsForHook;
//       requestUrl: string;
//       className?: string;
//       resetToDefaults: (operation?: DeepcrawlOperations) => void;
//     }
...
//       options: GetMarkdownOptionsForHook;
//       requestUrl: string;
//       className?: string;
//       resetToDefaults: (operation?: DeepcrawlOperations) => void;
//     };
...
//                   const value = option.getValue(getOptionValue);
