---
title: Introduction
description: Deepcrawl is a no-pricing, 100% free and fully open-source AI agents oriented web page context extraction platform. Open Source. Open Code.
---
...
- **[`getMarkdown`](/docs/features/read/getMarkdown):** Fast GET endpoint that returns prompt-ready markdown—ideal for caching snippets or feeding LLM prompts.
- **[`readUrl`](/docs/features/read/readUrl):** Full POST operation with metadata, cleaned HTML, markdown, robots, sitemap data, and metrics in one payload.
- **[`extractLinks`](/docs/features/links/extractLinks):** Configurable crawl endpoint that builds a agent-navigable links tree, filters external/media links.
